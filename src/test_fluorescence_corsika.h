...
C  MTHOUT      = FLAG TO INDICATE MULTITHIN OUTPUT
C
#endif
C --------------/CRMULTS/-------------------------
C  (SEE EGS4 MANUAL)
...
C
C --------------/CRRECORD/-----------------------
C  DRECOR      = # WORDS WRITTEN ON PARTICLE TAPE RECORDS
C
C --------------/CRREJECT/-----------------------
...
C  FECTACT     = FLAG INDICATING THE PARTICLE WERE NOT WRITTEN OUT YET
...
C  IMWEIC      = INDEX OF MULTITHIN WEIGHT USED IN COAST
#endif
C  INBIN(40)   = COUNTER FOR NUCLEON TABLE FOR SHOWER
C  INECHI(124) = INTERACTION LENGTH STATISTICS FOR NEUTRINOS
#if __INTTEST__
...
#ifdef __RECORDINC__
/*-- Author :    The CORSIKA development group   21/04/1994 */
      COMMON /CRRECORD/DRECOR
      DOUBLE PRECISION DRECOR
#undef __RECORDINC__
#endif
...
c     INTEGER          LUNHST
     ...
     *                 ,FIMPCT
      ...
      INTEGER          MPIID
      LOGICAL          FECTOUT,FECTEGS,FECTACT,FPRIM
...
/*-- Author :    The CORSIKA development group   21/04/1994 */
     ...
     *                 CERSIZ,FLSIZE,CERNOR,WLMAX,WLMIN,MCERFI,LCERDB
      DOUBLE PRECISION CERELE,CERHAD,ETADSN,WAVLGL,WAVLGU,CYIELD,
     *                 CERSIZ,FLSIZE,CERNOR,WLMAX,WLMIN
      INTEGER          MCERFI
      LOGICAL          LCERDB
#undef __CEREN1INC__
#endif
